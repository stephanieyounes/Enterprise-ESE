...
if (isset($_REQUEST['msg']) && ($_REQUEST['msg']=="success"))
{
	...
	echo 'Document successfully uploaded!</div>';
        ...
        echo '<th><h1 class="page-head-line">Upload a New File to DocStorage</h1></th>';
...
echo '<div class="form-group">';
 echo '<button class="fileupload-new"><a href="search.php">search.php</a></button>';
...
//	$uploadBy="user@test.mail";
	...
	$sql="Insert into `documents` (`name`,`path`,`upload_date`,`file_type`,`content`) values ('$fileName','$path','$uploadDate','$docType','$contentsClean')";
//	$dblink->query($sql) or
//		die("Something went wrong with $sql<br>".$dblink->error);
	
	if($dblink->query($sql))
	{
		header("Location: https://ec2-35-172-134-194.compute-1.amazonaws.com/upload.php?msg=success");
